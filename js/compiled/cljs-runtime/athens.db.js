...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46314_SHARP_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__46321){
var vec__46330 = p__46321;
...
}),cljs.core.PersistentArrayMap.EMPTY,p1__46314_SHARP_);
}),hms);
}
});
/**
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46342_SHARP_){
return cljs.core.cons(new cljs.core.Keyword("db","add","db/add",235286841),p1__46342_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46341_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.edn.read_string,p1__46341_SHARP_);
...
athens.db.rfdb = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"user","user",1532431356),"Jeff",new cljs.core.Keyword(null,"current-route","current-route",2067529448),null,new cljs.core.Keyword(null,"loading","loading",-737050189),true,new cljs.core.Keyword(null,"errors","errors",-908790718),cljs.core.PersistentArrayMap.EMPTY], null);
}
