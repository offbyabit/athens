...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42906){
var G__42907 = cljs.core.first(seq42906);
var seq42906__$1 = cljs.core.next(seq42906);
var G__42908 = cljs.core.first(seq42906__$1);
var seq42906__$2 = cljs.core.next(seq42906__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42907,G__42908,seq42906__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42919_SHARP_){
return (!((cljs.core.meta(p1__42919_SHARP_) == null)));
})))){
...
var map__42936 = opts;
var map__42936__$1 = (((((!((map__42936 == null))))?(((((map__42936.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42936.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42936):map__42936);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42936__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42942){var _e__40258__auto__ = e42942;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e42948){var _e__40258__auto__ = e42948;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42951 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42952 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42952);

try{var map__42954 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42954__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42951);
}});
...
var temp__5733__auto___43069 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43069)){
var managed_print_level_43070 = temp__5733__auto___43069;
var _STAR_print_level_STAR__orig_val__42979_43073 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42980_43074 = managed_print_level_43070;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42980_43074);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42966_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42966_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42979_43073);
}} else {
job_fn();
}
