...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42899){
var G__42900 = cljs.core.first(seq42899);
var seq42899__$1 = cljs.core.next(seq42899);
var G__42931 = cljs.core.first(seq42899__$1);
var seq42899__$2 = cljs.core.next(seq42899__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42900,G__42931,seq42899__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42946_SHARP_){
return (!((cljs.core.meta(p1__42946_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42973__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42977){var _e__40264__auto__ = e42977;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e42979){var _e__40264__auto__ = e42979;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43012 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43013 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43013);

try{var map__43016 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43016__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43012);
}});
...
var temp__5733__auto___43111 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43111)){
var managed_print_level_43112 = temp__5733__auto___43111;
var _STAR_print_level_STAR__orig_val__43051_43113 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43052_43114 = managed_print_level_43112;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43052_43114);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43024_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43024_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43051_43113);
}} else {
job_fn();
}
