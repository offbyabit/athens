...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__51706){
var vec__51707 = p__51706;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51707,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51707,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__51715_SHARP_){
return (((p1__51715_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__51715_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__51719,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__51719;
}
});
...
var len__4789__auto___51749 = arguments.length;
var i__4790__auto___51750 = (0);
while(true){
if((i__4790__auto___51750 < len__4789__auto___51749)){
args__4795__auto__.push((arguments[i__4790__auto___51750]));

var G__51754 = (i__4790__auto___51750 + (1));
i__4790__auto___51750 = G__51754;
continue;
} else {
}
break;
...
var G__51721 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51721,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__51721;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq51720){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq51720));
}));
...
var vec__51728 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__51733 = cljs.core.ffirst(matches);
var fexpr__51732 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__51732.cljs$core$IFn$_invoke$arity$1 ? fexpr__51732.cljs$core$IFn$_invoke$arity$1(G__51733) : fexpr__51732.call(null,G__51733));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51728,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51728,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__51726_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__51726_SHARP_))){
return p1__51726_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__51727_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__51727_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__51738){
...
var tag = first__51741;
var content = seq__51740__$1;
...
var vec__51743 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51743,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51743,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51743,(2),null);
