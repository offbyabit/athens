...
var len__4789__auto___60370 = arguments.length;
var i__4790__auto___60371 = (0);
while(true){
if((i__4790__auto___60371 < len__4789__auto___60370)){
args__4795__auto__.push((arguments[i__4790__auto___60371]));

var G__60372 = (i__4790__auto___60371 + (1));
i__4790__auto___60371 = G__60372;
continue;
} else {
}
break;
...
var G__60351 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60351,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__60351;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq60344){
...
var vec__60354 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__60358 = cljs.core.ffirst(matches);
var fexpr__60357 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__60357.cljs$core$IFn$_invoke$arity$1 ? fexpr__60357.cljs$core$IFn$_invoke$arity$1(G__60358) : fexpr__60357.call(null,G__60358));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60354,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60354,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__60352_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__60352_SHARP_))){
return p1__60352_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__60353_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__60353_SHARP_));
