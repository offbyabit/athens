...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__53745 = cljs.core.get_global_hierarchy;
return (fexpr__53745.cljs$core$IFn$_invoke$arity$0 ? fexpr__53745.cljs$core$IFn$_invoke$arity$0() : fexpr__53745.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("devcards.util.markdown","block-parser"),(function (p__53746,line){
...
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53748__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"markdown","markdown",1227225089)], null),(function (p__53752,line){
var map__53753 = p__53752;
var map__53753__$1 = (((((!((map__53753 == null))))?(((((map__53753.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53753.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53753):map__53753);
var st = map__53753__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53753__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var left_margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53753__$1,new cljs.core.Keyword(null,"left-margin","left-margin",1869643147));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"code-block","code-block",-2113425141)], null),(function (p__53758,line){
...
var st = map__53759__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53759__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delim","delim",1621565472),new cljs.core.Keyword(null,"markdown","markdown",1227225089)], null),(function (p__53761,line){
var map__53763 = p__53761;
...
var st = map__53763__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53763__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53763__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
...
devcards.util.markdown.block_parser.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delim","delim",1621565472),new cljs.core.Keyword(null,"code-block","code-block",-2113425141)], null),(function (p__53767,line){
...
var st = map__53768__$1;
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53768__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53768__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
...
var map__53774 = devcards.util.markdown.parse_out_blocks_STAR_(m);
var map__53774__$1 = (((((!((map__53774 == null))))?(((((map__53774.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53774.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53774):map__53774);
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53774__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var accum = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53774__$1,new cljs.core.Keyword(null,"accum","accum",-1892427250));
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(x,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"content","content",15833224)], null),(function (p1__53773_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",p1__53773_SHARP_);
}));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__53779){
...
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53780__$1,new cljs.core.Keyword(null,"content","content",15833224));
