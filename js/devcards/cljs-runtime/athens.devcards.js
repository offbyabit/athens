...
var data = map__48003__$1;
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48003__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var weight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48003__$1,new cljs.core.Keyword(null,"weight","weight",-1262796205));
var bmi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48003__$1,new cljs.core.Keyword(null,"bmi","bmi",1421979636));
var h = (height / (100));
if((bmi == null)){
...
var map__48005 = athens.devcards.calc_bmi(cljs.core.deref(bmi_data));
...
var weight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48005__$1,new cljs.core.Keyword(null,"weight","weight",-1262796205));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48005__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var bmi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48005__$1,new cljs.core.Keyword(null,"bmi","bmi",1421979636));
var vec__48006 = (((bmi < 18.5))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["orange","underweight"], null):(((bmi < (25)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["inherit","normal"], null):(((bmi < (30)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["orange","overweight"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["red","obese"], null)
)));
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48006,(0),null);
var diagnose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48006,(1),null);
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.t_athens$devcards48010 !== 'undefined')){
} else {
...
*/
athens.devcards.t_athens$devcards48010 = (function (meta48011){
this.meta48011 = meta48011;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.t_athens$devcards48010.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_48012,meta48011__$1){
var self__ = this;
var _48012__$1 = this;
return (new athens.devcards.t_athens$devcards48010(meta48011__$1));
}));

(athens.devcards.t_athens$devcards48010.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_48012){
var self__ = this;
var _48012__$1 = this;
return self__.meta48011;
}));

(athens.devcards.t_athens$devcards48010.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.t_athens$devcards48010.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__46709__auto__,devcard_opts__46710__auto__){
var self__ = this;
...
(athens.devcards.t_athens$devcards48010.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta48011","meta48011",-1696494956,null)], null);
}));

(athens.devcards.t_athens$devcards48010.cljs$lang$type = true);

(athens.devcards.t_athens$devcards48010.cljs$lang$ctorStr = "athens.devcards/t_athens$devcards48010");

(athens.devcards.t_athens$devcards48010.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards/t_athens$devcards48010");
}));

/**
 * Positional factory function for athens.devcards/t_athens$devcards48010.
 */
athens.devcards.__GT_t_athens$devcards48010 = (function athens$devcards$__GT_t_athens$devcards48010(meta48011){
return (new athens.devcards.t_athens$devcards48010(meta48011));
});

}

return (new athens.devcards.t_athens$devcards48010(null));
})()
