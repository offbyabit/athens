...
posh.core.empty_tree = (function posh$core$empty_tree(p__59045,retrieve){
var map__59046 = p__59045;
...
var dcfg = map__59046__$1;
var q = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59046__$1,new cljs.core.Keyword(null,"q","q",689001697));
var pull = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59046__$1,new cljs.core.Keyword(null,"pull","pull",-860544805));
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59046__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var entid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59046__$1,new cljs.core.Keyword(null,"entid","entid",1720688982));
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59046__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
(posh.core.add_db.cljs$core$IFn$_invoke$arity$5 = (function (p__59050,db_id,conn,schema,base_filters){
var map__59051 = p__59050;
var map__59051__$1 = (((((!((map__59051 == null))))?(((((map__59051.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59051.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__59051):map__59051);
var posh_tree = map__59051__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59051__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var conns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59051__$1,new cljs.core.Keyword(null,"conns","conns",-1475268193));
var schemas = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59051__$1,new cljs.core.Keyword(null,"schemas","schemas",575070579));
var dbs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59051__$1,new cljs.core.Keyword(null,"dbs","dbs",1889628467));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59051__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var graph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59051__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
...
(posh.core.set_db.cljs$core$IFn$_invoke$arity$4 = (function (p__59056,db_id,db,filter_pred){
...
var posh_tree = map__59057__$1;
var dbs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59057__$1,new cljs.core.Keyword(null,"dbs","dbs",1889628467));
var graph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59057__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59057__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var storage_key = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"db","db",993250759),db_id], null);
...
posh.core.add_filter_tx = (function posh$core$add_filter_tx(p__59059,poshdb,tx_patterns){
...
posh.core.add_filter_pull = (function posh$core$add_filter_pull(p__59062,poshdb,pull_pattern,eid){
...
var posh_tree = map__59063__$1;
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59063__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var graph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59063__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59063__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var conns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59063__$1,new cljs.core.Keyword(null,"conns","conns",-1475268193));
var conns_by_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59063__$1,new cljs.core.Keyword(null,"conns-by-id","conns-by-id",-369445996));
...
var len__4789__auto___59172 = arguments.length;
var i__4790__auto___59173 = (0);
while(true){
if((i__4790__auto___59173 < len__4789__auto___59172)){
args__4795__auto__.push((arguments[i__4790__auto___59173]));

var G__59174 = (i__4790__auto___59173 + (1));
i__4790__auto___59173 = G__59174;
continue;
} else {
}
break;
...
(posh.core.add_filter_q.cljs$core$IFn$_invoke$arity$variadic = (function (p__59069,query,args){
...
var posh_tree = map__59070__$1;
var graph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59070__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59070__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59070__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59070__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var conns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59070__$1,new cljs.core.Keyword(null,"conns","conns",-1475268193));
var conns_by_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59070__$1,new cljs.core.Keyword(null,"conns-by-id","conns-by-id",-369445996));
...
var cached = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,storage_key);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3((cljs.core.truth_(cached)?posh_tree:(function (){var map__59072 = posh.lib.update.update_q_with_dbvarmap(posh_tree,storage_key);
...
var analysis = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59072__$1,new cljs.core.Keyword(null,"analysis","analysis",-1362593389));
var dbvarmap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59072__$1,new cljs.core.Keyword(null,"dbvarmap","dbvarmap",491069137));
...
/** @this {Function} */
(posh.core.add_filter_q.cljs$lang$applyTo = (function (seq59065){
...
posh.core.add_pull = (function posh$core$add_pull(p__59074,poshdb,pull_pattern,eid){
...
posh.core.add_pull_many = (function posh$core$add_pull_many(p__59077,poshdb,pull_pattern,eids){
...
var posh_tree = map__59078__$1;
var graph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59078__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59078__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59078__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var conns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59078__$1,new cljs.core.Keyword(null,"conns","conns",-1475268193));
var conns_by_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59078__$1,new cljs.core.Keyword(null,"conns-by-id","conns-by-id",-369445996));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59078__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
...
(posh.core.add_q.cljs$core$IFn$_invoke$arity$variadic = (function (p__59083,query,args){
...
var posh_tree = map__59084__$1;
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59084__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var graph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59084__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59084__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var conns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59084__$1,new cljs.core.Keyword(null,"conns","conns",-1475268193));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59084__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
...
var map__59086 = posh.lib.update.update_q_with_dbvarmap(posh_tree,storage_key);
...
var analysis = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59086__$1,new cljs.core.Keyword(null,"analysis","analysis",-1362593389));
var dbvarmap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59086__$1,new cljs.core.Keyword(null,"dbvarmap","dbvarmap",491069137));
...
/** @this {Function} */
(posh.core.add_q.cljs$lang$applyTo = (function (seq59080){
var G__59081 = cljs.core.first(seq59080);
var seq59080__$1 = cljs.core.next(seq59080);
var G__59082 = cljs.core.first(seq59080__$1);
var seq59080__$2 = cljs.core.next(seq59080__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__59081,G__59082,seq59080__$2);
}));

posh.core.remove_item = (function posh$core$remove_item(p__59088,storage_key){
...
posh.core.cache_changes = (function posh$core$cache_changes(p__59091,db_id,tx,new_cache,storage_key){
var map__59092 = p__59091;
...
var posh_tree = map__59092__$1;
var graph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59092__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59092__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
...
var reloaded = (cljs.core.truth_(posh.lib.datom_matcher.any_datoms_match_QMARK_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"reload-patterns","reload-patterns",-1261746666).cljs$core$IFn$_invoke$arity$1(current_analysis),db_id),tx))?(function (){var fexpr__59095 = new cljs.core.Keyword(null,"reload-fn","reload-fn",-1150160860).cljs$core$IFn$_invoke$arity$1(current_analysis);
return (fexpr__59095.cljs$core$IFn$_invoke$arity$2 ? fexpr__59095.cljs$core$IFn$_invoke$arity$2(posh_tree,storage_key) : fexpr__59095.call(null,posh_tree,storage_key));
})():null);
...
var map__59094 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(graph,storage_key);
...
var outputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59094__$1,new cljs.core.Keyword(null,"outputs","outputs",-1896513034));
...
posh.core.add_tx = (function posh$core$add_tx(p__59099,poshdb,tx){
var map__59100 = p__59099;
...
var posh_tree = map__59100__$1;
var txs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59100__$1,new cljs.core.Keyword(null,"txs","txs",2056038378));
var conns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59100__$1,new cljs.core.Keyword(null,"conns","conns",-1475268193));
