...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__45519 = cljs.core.get_global_hierarchy;
return (fexpr__45519.cljs$core$IFn$_invoke$arity$0 ? fexpr__45519.cljs$core$IFn$_invoke$arity$0() : fexpr__45519.call(null));
})());
...
re_posh.subs.execute_sub.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"query","query",-1288509510),(function (p__45520){
...
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45521__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var variables = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45521__$1,new cljs.core.Keyword(null,"variables","variables",1563680814));
...
re_posh.subs.execute_sub.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"pull","pull",-860544805),(function (p__45523){
...
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45524__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45524__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var G__45526 = cljs.core.deref(re_posh.db.store);
var G__45527 = pattern;
var G__45528 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__45526,G__45527,G__45528) : posh.reagent.pull.call(null,G__45526,G__45527,G__45528));
}));
re_posh.subs.execute_sub.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"pull-many","pull-many",217148130),(function (p__45533){
...
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45534__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45534__$1,new cljs.core.Keyword(null,"ids","ids",-998535796));
var G__45538 = cljs.core.deref(re_posh.db.store);
var G__45539 = pattern;
var G__45540 = ids;
return (posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3(G__45538,G__45539,G__45540) : posh.reagent.pull_many.call(null,G__45538,G__45539,G__45540));
}));
/**
...
var len__4789__auto___45567 = arguments.length;
var i__4790__auto___45568 = (0);
while(true){
if((i__4790__auto___45568 < len__4789__auto___45567)){
args__4795__auto__.push((arguments[i__4790__auto___45568]));

var G__45569 = (i__4790__auto___45568 + (1));
i__4790__auto___45568 = G__45569;
continue;
} else {
}
break;
...
var inputs_fn = (function (){var G__45543 = cljs.core.count(input_args);
switch (G__45543) {
case (0):
return (function() {
var G__45571 = null;
var G__45571__1 = (function (_){
return null;
});
var G__45571__2 = (function (_,___$1){
return null;
});
G__45571 = function(_,___$1){
switch(arguments.length){
case 1:
return G__45571__1.call(this,_);
case 2:
return G__45571__2.call(this,_,___$1);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__45571.cljs$core$IFn$_invoke$arity$1 = G__45571__1;
G__45571.cljs$core$IFn$_invoke$arity$2 = G__45571__2;
return G__45571;
})()
...
break;
case (2):
var vec__45544 = input_args;
var marker = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45544,(0),null);
var vec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45544,(1),null);
...
var G__45547 = (function (){var G__45548 = cljs.core.deref(cljs.core.deref(re_posh.db.store));
var G__45549 = params;
return (config_fn.cljs$core$IFn$_invoke$arity$2 ? config_fn.cljs$core$IFn$_invoke$arity$2(G__45548,G__45549) : config_fn.call(null,G__45548,G__45549));
})();
return (re_posh.subs.execute_sub.cljs$core$IFn$_invoke$arity$1 ? re_posh.subs.execute_sub.cljs$core$IFn$_invoke$arity$1(G__45547) : re_posh.subs.execute_sub.call(null,G__45547));
} else {
...
return cljs.core.deref((function (){var G__45550 = (config_fn.cljs$core$IFn$_invoke$arity$2 ? config_fn.cljs$core$IFn$_invoke$arity$2(signals,params) : config_fn.call(null,signals,params));
return (re_posh.subs.execute_sub.cljs$core$IFn$_invoke$arity$1 ? re_posh.subs.execute_sub.cljs$core$IFn$_invoke$arity$1(G__45550) : re_posh.subs.execute_sub.call(null,G__45550));
})());
}));
}
}));
...
/** @this {Function} */
(re_posh.subs.reg_sub.cljs$lang$applyTo = (function (seq45541){
var G__45542 = cljs.core.first(seq45541);
var seq45541__$1 = cljs.core.next(seq45541);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45542,seq45541__$1);
}));
...
return re_posh.subs.reg_sub.cljs$core$IFn$_invoke$arity$variadic(sub_name,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (_,p__45551){
var vec__45552 = p__45551;
var seq__45553 = cljs.core.seq(vec__45552);
var first__45554 = cljs.core.first(seq__45553);
var seq__45553__$1 = cljs.core.next(seq__45553);
var ___$1 = first__45554;
var params = seq__45553__$1;
...
return re_posh.subs.reg_sub.cljs$core$IFn$_invoke$arity$variadic(sub_name,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (_,p__45555){
var vec__45556 = p__45555;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45556,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45556,(1),null);
...
return re_posh.subs.reg_sub.cljs$core$IFn$_invoke$arity$variadic(sub_name,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (_,p__45559){
var vec__45560 = p__45559;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45560,(0),null);
var ids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45560,(1),null);
